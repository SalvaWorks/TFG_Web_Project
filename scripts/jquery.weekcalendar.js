...
(function($) {
    ...
    $.widget('ui.weekCalendar', (function() {
        let _currentAjaxCall, _hourLineTimeout;
        ...
        return {
                options: {
                    ...
                    shortDays: ['Dg', 'Dll', 'Dm', 'Dim', 'Dj', 'Dv', 'Dis'],
                    longDays: ['Diumenge', 'Dilluns', 'Dimarts', 'Dimecres', 'Dijous', 'Divendres', 'Disaabte'],
                    /* multi-users options */
                    /**
                ...
                removeEvent: function(eventId) {
                    ...
                    self.element.find('.wc-cal-event').each(function() {
                        if ($(this).data('calEvent').id === eventId) { //eventid
                            $(this).remove();
                            return false;
                        }
                    });
...
//              calendarHeaderHtml+=    "</div>";
                ...
                _renderCalendarBody: function($calendarContainer) {
                    ...
                    $calendarContainer.find('.wc-full-height-column').height(options.timeslotHeight * options.timeslotsPerDay); //+40
                    ...
                    $calendarContainer.find('.wc-time-header-cell').css({
                        height: (options.timeslotHeight * options.timeslotsPerHour) -9, //habia un -6
                        padding: 4
                    });
                ...
                _renderCalendarBodyTimeSlots: function($calendarTableTbody) {
                    var options = this.options,
                        ...
                        end = (options.businessHours.limitDisplay ? options.businessHours.end : 20),
                        rowspan = 1;
                    ...
                    renderRow += '<td colspan=\"' + options.daysToShow + '\">';
                ...
                _setupEventCreationForWeekDay: function($weekDay) {
                    ...
                    $weekDay.mousedown(function(event) {
                        ...
                        if ($newEvent.length) {
                            ...
                            options.newEventText= self._getText();
            ...
            _getText: function (){
                if(teoria == 1) {
                    ...
                    if (problemes == 1) {
                        return 'Problemes'
                    } else if(practiques == 1) {
                        return 'Practiques'}
                    else {
                        alert('Selecciona primer quin tipus de classe vols afegir a l horari.')
                        return 'Indefinit';
                    }
                }
            },
                /*
                  ...
                  */
                _loadCalEvents: function(dateWithinWeek) { //mirar de forzar fecha
                    console.log(dateWithinWeek);
                ...
                _renderEvents: function(data, $weekDayColumns) {
                    ...
                    $.each(eventsToRender, function(i, calEvent) {
                        ...
                        var maxHour = self.options.businessHours.limitDisplay ? self.options.businessHours.end : 20;
                        var minHour = self.options.businessHours.limitDisplay ? self.options.businessHours.start : 8;
                ...
                _renderEvent: function(calEvent, $weekDay) {
                    ...
                    //window.localStorage.setItem("calevent_keys", Object.keys(calEvent)[0]);
                    window.localStorage.setItem("calevent_keys", Object.keys(calEvent).toString());
                    window.localStorage.setItem("calevent_values", Object.values(calEvent));


                    options.storageList.push("franja:", Object.values(calEvent).toString())
                    window.localStorage.setItem("calevent_local_values", options.storageList);
                ...
                /*
                  ...
                  */
                _adjustForEventCollisions: function($weekDay, $calEvent, newCalEvent, oldCalEvent, maintainEventDuration) { //important
                    var options = this.options;
                    console.log('si');
